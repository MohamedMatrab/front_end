...
<body>
  ...
  <div class="container">
    ...
    <form action="Models/signup_action.php" method="post" class="form-login">
      ...
      <div class="mb-3">
        <input type="password" id="pswd" name="password" class="form-control" placeholder="Enter Password" required />
        <label for="pswd" class="form-label" id="password_strength"></label>
      </div>
      <div class="mb-3">
        <input type="password" id="pswd-confirm" name="confirm_password" class="form-control" placeholder="Confirm Password" required />
      ...
      <div class="agreement mb-3 mt-3">
        <label for="accept agreements" class="form-check-label" id="accept-agreement">
          <input type="checkbox" checked class="form-check-input" name="agreement" required />
