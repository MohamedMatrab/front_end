...
$query->execute();
$query1 = $obj->getConnect()->prepare("SELECT * FROM service_details");
$query1->execute();
...
if (!empty($search)) {
    $query = $obj->getConnect()->prepare("SELECT * FROM services WHERE Nom_du_service LIKE :search");
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="myForm" action="Models/add_service.php" method="POST" enctype="multipart/form-data">
